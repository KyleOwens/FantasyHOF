...
namespace FantasyHOF.EntityFramework.Migrations
{
    ...
    [Migration("20251230192058_Initial")]
            ...
            modelBuilder.Entity("FantasyHOF.Domain.Types.TeamMatchup", b =>
                {
                    ...
                    b.Property<int?>("OpponentMatchupId")
                        .HasColumnType("integer")
                        .HasColumnName("opponent_matchup_id");
                    ...
                    b.HasIndex("OpponentMatchupId")
                        .IsUnique()
                        .HasDatabaseName("ix_team_matchups_opponent_matchup_id");
            ...
            modelBuilder.Entity("FantasyHOF.Domain.Types.TeamMatchup", b =>
                {
                    ...
                    b.HasOne("FantasyHOF.Domain.Types.TeamMatchup", "OpponentMatchup")
                        .WithOne()
                        .HasForeignKey("FantasyHOF.Domain.Types.TeamMatchup", "OpponentMatchupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_team_matchups_team_matchups_opponent_matchup_id");
