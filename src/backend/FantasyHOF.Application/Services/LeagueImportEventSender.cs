...
namespace FantasyHOF.Application.Services
{
    public interface ILeagueImportEventSender
    {
        ...
        public Task Complete(LeagueImport import, CancellationToken cancellationToken);
    ...
    { 
        ...
        public async Task Complete(LeagueImport import, CancellationToken cancellationToken)
        {
